...
function CardHeader({ icon:Icon, title, badge, badgeStatus="info" }: { icon:React.ElementType; title:string; badge?:string; badgeStatus?:string }) {
  return (
    <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100">
      <h3 className="text-xs font-semibold text-slate-700 flex items-center gap-2"><Icon className="w-3.5 h-3.5 text-slate-400"/>{title}</h3>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-50 to-blue-50/20 font-sans">
      <div className="max-w-screen-2xl mx-auto p-5 space-y-1">
        ...
        <CardShell>
          <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100">
            <h3 className="text-xs font-semibold text-slate-700 flex items-center gap-2"><ShoppingCart className="w-3.5 h-3.5 text-slate-400"/>Recent orders</h3>
